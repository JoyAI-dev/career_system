  ...
  const prefCategories: SeedPrefCategory[] = [
    ...
    },
    {
      ...
      options: [
        ...
        { label: '金融', value: 'finance', order: 3 },
        { label: '咨询', value: 'consulting', order: 4 },
        { label: '医疗健康', value: 'healthcare', order: 5 },
        { label: '教育/培训', value: 'education', order: 6 },
        { label: '制造业', value: 'manufacturing', order: 7 },
        { label: '能源/环保', value: 'energy', order: 8 },
        { label: '消费品/零售', value: 'retail', order: 9 },
        { label: '文化/传媒/娱乐', value: 'media', order: 10 },
        { label: '房地产/建筑', value: 'real-estate', order: 11 },
        { label: '汽车', value: 'automotive', order: 12 },
        { label: '物流/交通', value: 'logistics', order: 13 },
        { label: '法律', value: 'legal', order: 14 },
        { label: '餐饮/酒店/旅游', value: 'hospitality', order: 15 },
        { label: '农业/林业', value: 'agriculture', order: 16 },
        { label: '政府/公共事业', value: 'government', order: 17 },
        { label: '通信/电信', value: 'telecom', order: 18 },
        { label: '半导体/芯片/电子', value: 'semiconductor', order: 19 },
        { label: '人工智能/大数据', value: 'ai-bigdata', order: 20 },
        { label: '航空航天/国防军工', value: 'aerospace-defense', order: 21 },
        { label: '生物科技/制药', value: 'biotech-pharma', order: 22 },
        { label: '广告/营销/公关', value: 'advertising-pr', order: 23 },
        { label: '游戏', value: 'gaming', order: 24 },
        { label: '设计/创意', value: 'design-creative', order: 25 },
        // 其他
        { label: '其他', value: 'other', order: 99 },
      ],
    },
