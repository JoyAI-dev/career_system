  ...
  const prefCategories: SeedPrefCategory[] = [
    {
      ...
      options: [
        ...
        { label: '长沙', value: 'changsha', order: 13 },
        { label: '郑州', value: 'zhengzhou', order: 14 },
        { label: '合肥', value: 'hefei', order: 15 },
        { label: '青岛', value: 'qingdao', order: 16 },
        { label: '东莞', value: 'dongguan', order: 17 },
        { label: '宁波', value: 'ningbo', order: 18 },
        { label: '佛山', value: 'foshan', order: 19 },
        // 重点二线城市
        { label: '大连', value: 'dalian', order: 20 },
        { label: '厦门', value: 'xiamen', order: 21 },
        { label: '昆明', value: 'kunming', order: 22 },
        { label: '福州', value: 'fuzhou', order: 23 },
        { label: '济南', value: 'jinan', order: 24 },
        { label: '无锡', value: 'wuxi', order: 25 },
        { label: '珠海', value: 'zhuhai', order: 26 },
        { label: '沈阳', value: 'shenyang', order: 27 },
        // 补充二线城市（省会及经济强市）
        { label: '哈尔滨', value: 'harbin', order: 28 },
        { label: '南宁', value: 'nanning', order: 29 },
        { label: '贵阳', value: 'guiyang', order: 30 },
        { label: '太原', value: 'taiyuan', order: 31 },
        { label: '南昌', value: 'nanchang', order: 32 },
        { label: '石家庄', value: 'shijiazhuang', order: 33 },
        { label: '常州', value: 'changzhou', order: 34 },
        { label: '温州', value: 'wenzhou', order: 35 },
        { label: '泉州', value: 'quanzhou', order: 36 },
        { label: '惠州', value: 'huizhou', order: 37 },
        // 三线城市（省会及重要经济城市）
        { label: '兰州', value: 'lanzhou', order: 38 },
        { label: '海口', value: 'haikou', order: 39 },
        { label: '呼和浩特', value: 'hohhot', order: 40 },
        { label: '银川', value: 'yinchuan', order: 41 },
        { label: '西宁', value: 'xining', order: 42 },
        { label: '嘉兴', value: 'jiaxing', order: 43 },
        { label: '中山', value: 'zhongshan', order: 44 },
        { label: '绍兴', value: 'shaoxing', order: 45 },
        { label: '烟台', value: 'yantai', order: 46 },
        { label: '洛阳', value: 'luoyang', order: 47 },
        { label: '徐州', value: 'xuzhou', order: 48 },
        { label: '保定', value: 'baoding', order: 49 },
        { label: '芜湖', value: 'wuhu', order: 50 },
        { label: '扬州', value: 'yangzhou', order: 51 },
        { label: '桂林', value: 'guilin', order: 52 },
        // 四线城市（代表性城市）
        { label: '拉萨', value: 'lhasa', order: 53 },
        { label: '三亚', value: 'sanya', order: 54 },
        { label: '柳州', value: 'liuzhou', order: 55 },
        { label: '湛江', value: 'zhanjiang', order: 56 },
        { label: '宜昌', value: 'yichang', order: 57 },
        { label: '镇江', value: 'zhenjiang', order: 58 },
        { label: '遵义', value: 'zunyi', order: 59 },
        { label: '赣州', value: 'ganzhou', order: 60 },
        { label: '绵阳', value: 'mianyang', order: 61 },
        { label: '威海', value: 'weihai', order: 62 },
        // 港澳台
        { label: '香港', value: 'hongkong', order: 63 },
        { label: '澳门', value: 'macau', order: 64 },
        { label: '台北', value: 'taipei', order: 65 },
        { label: '高雄', value: 'kaohsiung', order: 66 },
        { label: '台中', value: 'taichung', order: 67 },
        // 海外
        { label: '海外', value: 'overseas', order: 98 },
        // 其他
        { label: '其他', value: 'other', order: 99 },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        // ── 互联网与科技 ──
        { label: '互联网/电商', value: 'internet-ecommerce', order: 1 },
        { label: '科技/IT', value: 'tech', order: 2 },
        { label: '人工智能/大数据', value: 'ai-bigdata', order: 3 },
        { label: '半导体/芯片/电子', value: 'semiconductor', order: 4 },
        { label: '通信/电信', value: 'telecom', order: 5 },
        { label: '游戏', value: 'gaming', order: 6 },
        { label: '网络安全', value: 'cybersecurity', order: 7 },
        { label: '云计算/SaaS', value: 'cloud-saas', order: 8 },
        // ── 金融与商业服务 ──
        { label: '银行', value: 'banking', order: 9 },
        { label: '证券/基金/投资', value: 'securities-investment', order: 10 },
        { label: '保险', value: 'insurance', order: 11 },
        { label: '会计/审计', value: 'accounting-audit', order: 12 },
        { label: '咨询', value: 'consulting', order: 13 },
        { label: '法律', value: 'legal', order: 14 },
        { label: '人力资源服务', value: 'hr-services', order: 15 },
        // ── 制造与工程 ──
        { label: '制造业', value: 'manufacturing', order: 16 },
        { label: '汽车', value: 'automotive', order: 17 },
        { label: '航空航天/国防军工', value: 'aerospace-defense', order: 18 },
        { label: '新能源/环保', value: 'new-energy', order: 19 },
        { label: '化工/材料', value: 'chemical-materials', order: 20 },
        { label: '机械/自动化', value: 'mechanical-automation', order: 21 },
        // ── 医疗与生命科学 ──
        { label: '医疗健康', value: 'healthcare', order: 22 },
        { label: '生物科技/制药', value: 'biotech-pharma', order: 23 },
        { label: '医疗器械', value: 'medical-devices', order: 24 },
        // ── 消费与服务 ──
        { label: '消费品/零售', value: 'retail', order: 25 },
        { label: '快消品/日化', value: 'fmcg', order: 26 },
        { label: '餐饮/酒店/旅游', value: 'hospitality', order: 27 },
        { label: '电商/直播', value: 'ecommerce-livestream', order: 28 },
        { label: '美容/个护', value: 'beauty-personalcare', order: 29 },
        { label: '体育/健身', value: 'sports-fitness', order: 30 },
        // ── 文化与创意 ──
        { label: '文化/传媒/娱乐', value: 'media', order: 31 },
        { label: '广告/营销/公关', value: 'advertising-pr', order: 32 },
        { label: '设计/创意', value: 'design-creative', order: 33 },
        { label: '影视/动漫', value: 'film-animation', order: 34 },
        // ── 基建与地产 ──
        { label: '房地产/建筑', value: 'real-estate', order: 35 },
        { label: '物流/供应链', value: 'logistics', order: 36 },
        { label: '交通/航运', value: 'transportation', order: 37 },
        // ── 公共与社会 ──
        { label: '教育/培训', value: 'education', order: 38 },
        { label: '政府/公共事业', value: 'government', order: 39 },
        { label: '社会组织/公益', value: 'ngo-nonprofit', order: 40 },
        // ── 其他传统行业 ──
        { label: '农业/林业', value: 'agriculture', order: 41 },
        { label: '矿业/冶金', value: 'mining-metallurgy', order: 42 },
        { label: '跨境贸易/外贸', value: 'cross-border-trade', order: 43 },
        // 其他
        { label: '其他', value: 'other', order: 99 },
      ],
    },
