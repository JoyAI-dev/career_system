...
function q(title: string, order: number): SeedQuestion {
  return { title, order, options: SLIDER_OPTIONS };
}
...
// ─── Questionnaire V2 data ────────────────────────────────────────────────────

const TOPICS_V2: SeedTopic[] = [
  // ── 1. 地点选择 ──────────────────────────────────────────────────────────────
  {
    name: '地点选择（中国城市列表）',
    order: 1,
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你选择的城市在中国是什么定位？有哪些支柱产业？为什么这些产业是支柱产业？有什么样的政策倾向？代表了什么样的职业环境和发展机会？是经济发达的地区，还是文化氛围浓厚的城市？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('这些支柱产业意味着什么样的政策倾向？选择特定的城市工作意味着你将面临哪些特定的生活成本、工作节奏和职业机遇？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('你选择的城市如何影响你感兴趣的行业和领域？比如，某些行业是否在某些城市更加集中？对市场趋势有什么样的影响？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('选择城市的同时，是否会改变你对行业或职业方向的兴趣？例如，大城市可能会带来更多的科技行业机会，农村地区可能更倾向于农业或基础设施项目。', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('在你选择的城市，人口组成结构你清楚吗？人才竞争状况如何？这些行业或者支柱产业或者政策倾向对人才流动有什么样的影响？你是否知道你在选择的城市的人才市场的定位和竞争力？', 1),
        ],
      },
    ],
  },
  ...
  // ── 4. 行业领域 ──────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你选择的是哪个行业？这个行业主要在中国的哪几个地方有政策扶持？这个行业有什么样的宏观政策倾向？这个行业是不是属于你所选择的城市的支柱产业？这个行业的核心驱动力和未来10年的趋势是什么样的？具有影响力的几个机构或企业都是哪几家？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('选择不同的行业意味着什么？它是一片蓝海还是红海？你对行业发展的前景和可能带来的职业机会有何期待？这个行业意味着什么样的人才画像？你是否了解转换行业意味着什么？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('你所选择的行业可能涉及哪些创新、技术应用或市场需求？它如何与其他领域相交叉？在现有的AI技术冲击下，你选择的行业面临着哪些必然的改变？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('你选择的这个行业是你的兴趣使然还是出于对现实的妥协？这两者你清楚对你未来的发展有什么样的影响吗？如果是出于对现实的妥协，你是否认为你能从这个行业中学习到与你的兴趣相结合的东西？你选择一个行业是否会让你逐渐进入一个更专注或更垂直的细分领域？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('你选择的行业目前所对应的人才市场是什么情况？行业的成熟度、竞争情况、人才供需如何影响你的职业发展？在现有的AI冲击下，你选择的行业的人才市场对人才画像是否有明确的人机协同的要求？你是否了解这个行业的人才市场在你所选择的城市的人才集中度以及竞争水平？', 1),
        ],
      },
    ],
  },
  ...
  // ── 5. 平台性质 ──────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你选择的是哪种类型的平台？国有企业、民营企业、外资企业，还是合资企业？你了解不同性质的平台的共性是什么吗？区别又是什么？你了解不同性质的平台是如何产生的？存在的意义是什么？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('不同性质的平台有何文化差异、工作流程和发展机会？不同的工作流程是否意味着不同的思维方式？这些对你未来想要的生活方式意味着什么？不同性质的平台意味着不同的人才画像吗？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('你理解不同性质的平台会在发展方向和行业选择上有所不同。你了解这些差异对你感兴趣的领域意味着什么吗？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('选择国内平台是否让你更倾向于一些政策导向和本地化需求较强的领域？外资平台可能让你更有机会接触到跨国运营和多元化发展。', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('平台的性质如何影响公司对人才的招聘标准和待遇？它如何影响你在求职市场上的竞争力？你了解人才市场如何看待不同性质的平台的人才吗？你了解不同性质的平台如何培养年轻的人才吗？', 1),
        ],
      },
    ],
  },
  ...
  // ── 6. 企业规模 ──────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你选择加入的是大企业、小企业，还是中型企业？你了解财富500强/跨国企业、百亿、亿、千万、百万或以下规模的企业的区别是什么？你了解你所选择的行业的不同规模的企业都有哪几家？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('企业规模对你职业发展的影响是什么？大企业有更多的培训和晋升机会，小企业则可能让你承担更多职责？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('企业规模可能决定了你能接触到的项目类型、技术发展方向以及跨部门的合作机会？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('大企业可能会让你更倾向于专注于某个小领域的深耕，而小企业或创业公司则要求你接触更广泛的工作内容。你能分清楚平台价值以及个人价值吗？你能分清楚你的兴趣在你选择的平台上会有多少发挥空间？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('不同规模的企业对年轻人才有着天差地别的画像，这是为什么？你了解从小企业向大企业、从大企业到小企业的职业发展路径吗？你了解人才市场如何看待一直在大企业的人才？大企业的人才有哪些短板？你了解人才市场如何看待一直在小企业的人才，又有哪些短板？', 1),
        ],
      },
    ],
  },
  ...
  // ── 7. 企业文化 ──────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你更喜欢扁平化结构还是垂直化结构的企业文化？这种不同设定的背后的底层逻辑是什么？你是否了解决策人使用某种特定的模式想要解决的问题、谋求的利益是什么？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('扁平化结构鼓励创新和灵活性，垂直化结构更注重管理规范和发展路径。你清楚扁平化的结构适合什么样的平台？不同的结构会对你的思维方式和做事逻辑造成什么样的影响？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('在不同文化结构下，你如何在工作中定位自己的角色？你了解垂直化的结构给平台带来的价值吗？你如何适应这种工作方式？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('如果你选择了扁平化结构，你是否更倾向于创新型、创业型的工作内容？垂直化结构是否更适合那些喜欢稳定和明确发展路径的人？你的兴趣在哪一种结构可以得到更大的发挥空间？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('在不同的企业文化中，你的职业发展会如何受到影响？如何评估这些文化对你的适应性？', 1),
        ],
      },
    ],
  },
  ...
  // ── 8. 领导风格 ──────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你喜欢哪种领导风格？专制型还是民主型？你了解不同性质不同规模的平台的领导风格吗？你了解中国的人才市场如何定义领导风格吗？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('不同的领导风格对团队合作、工作氛围、决策效率等有何影响？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('领导风格可能会影响你所在领域的创新性、灵活性和风险承担吗？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('专制型领导可能更适合高效执行，而民主型领导则适合鼓励创新和多方合作。你是否更倾向于选择支持你个性发展的领域？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('不同的领导风格会影响你的职业发展方向，尤其是在多变的市场环境中，不同风格的公司对人才的吸引力如何？', 1),
        ],
      },
    ],
  },
  ...
  // ── 10. 加班偏好 ─────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你能接受的工作时长和工作强度是怎样的（964/965/855/996/995/7×24）？目前中国的市场上你知道什么类型的平台在适用哪一种工作时长和工作强度？你了解964的这种工作时长目前只存在于中国的外资企业吗？你清楚不同工作强度的平台对人才的画像是什么样的吗？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('加班偏好的选择反映了你对工作与生活平衡的重视程度，以及对职业压力的适应能力。你清楚你自己想要什么样的平衡吗？你了解自己对压力的适应和处理能力吗？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('高强度的加班文化可能会出现在创业公司或某些高压行业，你的选择将影响你在这些领域的职业路径。你所选择的行业普遍的工作强度是什么样的？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('如果你选择了更高强度的工作模式，是否意味着你清楚这个强度对你的健康和生活的影响？你是否认为高强度的工作对应高回报行业（如金融、互联网等）？你了解多高强度对应多高的回报吗？你认为的回报里都有什么？你的兴趣排在第几位？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('人才市场上对加班文化的接受度如何？中国目前的人才市场对于工作强度与工作效率的定位是什么？你了解工作强度与工作效率的关系吗？你了解不同规模的平台对工作效率以及工作强度的定义和标准都有所不同吗？', 1),
        ],
      },
    ],
  },
  ...
  // ── 11. 假期天数/年 ──────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你期望的假期天数是多少（5天/10天/15天/20天/25天/45天/60天）？不同的假期政策都存在于什么类型的平台？作为年轻人才，你了解与管理层或者老员工的假期政策差别吗？你了解外资平台管理层与一线员工假期待遇无差别的原因吗？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('不同的假期政策反映工作与生活平衡的文化和对员工休息的重视程度。这对你未来的生活方式意味着什么？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('不同领域的假期政策差异如何影响你的工作状态和工作效率？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('你的兴趣需要哪个程度的员工福利和生活平衡的行业？你是否可以在你的兴趣与职业之间找到一个平衡？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('你的选择在人才市场上会被如何看待？你所选择的行业、城市与自我定位对你在假期的选择上有什么样的影响？', 1),
        ],
      },
    ],
  },
  ...
  // ── 12. 医疗保障 ─────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你期望的医疗保障水平是多少（普通/高端/定制）？这些不同的医疗保障分别对应哪些类型的平台？不同程度的医疗保障都分别包括哪些医疗选项？你是否了解中国目前对于外资投资及建立医院的政策倾向？你了解目前中国的哪些城市拥有多少三甲公立医院以及多少高水准的综合全科民营医院？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('不同的医疗保障意味着你对健康保障的重视程度，以及对工作环境中福利的期望。你认为牙科护理、私人医生等医疗保障对你来说意味着什么？对你的生活方式的选择意味着什么？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('某些领域（例如跨国公司或大型企业）可能会提供更高水平的医疗保障，这会影响你的选择吗？关于医疗保障，你是否会将它排在影响你选择的因素的前几位？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('你的兴趣领域是否要求有更好的医疗保障？如果你的自我定位对身体健康或精神健康有极大影响，你是否考虑过更换你的兴趣领域？你了解自己身体的物理极限吗？你了解自己的精神极限吗？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('不同的平台对员工健康保障的投入程度如何影响你在求职市场的选择？你所选择的领域对应的人才市场的医疗保障普遍是什么水平？包含哪些内容？涵盖哪些服务？所使用的频率是什么样的？', 1),
        ],
      },
    ],
  },
  ...
  // ── 13. 生育福利 ─────────────────────────────────────────────────────────────
  {
    ...
    dimensions: [
      {
        name: D1, order: 1, questions: [
          q('你期望的生育福利是什么（生育检查/生育检查+精子/卵子冷冻/生育检查+精子/卵子冷冻+孕期保障）？你知道中国为数不多提供员工生殖福利的平台有哪几个吗？你是否有清晰的婚育计划？你了解中国现行的法律对于生育方面的具体条款吗？你了解在你所选择的城市生和育的政策是什么？', 1),
        ],
      },
      {
        name: D2, order: 2, questions: [
          q('生育福利反映了一个公司或行业对员工家庭规划的支持程度。对于你的人生和生活方式意味着什么？如果你没有生育计划，你是否理解这在你选择的城市和平台的环境中意味着什么样的职业选择以及舆论压力？如果你有生育计划，你是否了解在你选择的城市和平台意味着什么样的物质和精神基础？', 1),
        ],
      },
      {
        name: D3, order: 3, questions: [
          q('哪些行业可能提供更为完善的生育福利（如某互联网公司提供女性员工冻卵的福利、某医疗大健康公司提供生殖遗传病的检测福利等等）？这可能会影响你对这些领域的兴趣吗？', 1),
        ],
      },
      {
        name: D4, order: 4, questions: [
          q('选择更好的生育福利可能使你倾向于那些注重员工生活质量和福利的公司或行业。你的生育计划如何影响你对行业和平台的选择？', 1),
        ],
      },
      {
        name: D5, order: 5, questions: [
          q('生育福利政策的优劣如何影响公司在市场中的竞争力，特别是在年轻人才的吸引上？你了解中国人才市场上不同城市不同行业对未婚未育、已婚未育、已婚已育、以及未婚已育男性和女性员工的生育定位吗？你知道女性员工生育假期的延长加重了女性在职场的困境吗？', 1),
        ],
      },
    ],
  },
...
// ─── Seeding helper (same idempotent pattern as seed.ts) ─────────────────────

async function seedTopicTree(versionId: string, topics: SeedTopic[]) {
...
async function main() {
  console.log('Seeding questionnaire version 2...');

  // Deactivate version 1 and create/activate version 2
  await prisma.$queryRaw(
    Prisma.sql`UPDATE questionnaire_versions SET "isActive" = false WHERE version = 1`,
  );

  const v2 = await prisma.questionnaireVersion.upsert({
    where: { version: 2 },
    update: { isActive: true },
    create: { version: 2, isActive: true },
  });

  console.log(`Questionnaire version 2 id: ${v2.id}`);

  await seedTopicTree(v2.id, TOPICS_V2);

  console.log('Done. Questionnaire v2 seeded with 13 topics × 5 dimensions.');
}
